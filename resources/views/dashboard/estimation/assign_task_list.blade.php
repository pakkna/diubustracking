@section('assign-tasks-view', 'mm-active')
                ...
                <div class="page-title-heading">
                    ...
                    <div>
                        ...
                        <div class="page-title-head center-elem">
                            ...
                            <span class="d-inline-block">Assign Task List</span>
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                           ...
                                           if(response==1){
                                              Swal.fire("Task", "Task Activity Deleted !", "success");
                                              $('#process_data_table').DataTable().ajax.reload();
                                            }else if(response==2){
                                              Swal.fire("Task", "Assign Task Completed", "success");
                                              $('#process_data_table').DataTable().ajax.reload();

                                            }else if(response==3){
                                              $('#cleaner_assign_table').click()
                                              Swal.fire("Assign Cleaner", "Cleaner deleted successfully", "success");
