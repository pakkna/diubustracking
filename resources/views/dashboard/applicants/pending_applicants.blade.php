...
@section('pending-applicants-list', 'mm-active')
                ...
                <div class="page-title-heading">
                    ...
                    <div>
                        ...
                        <div class="page-title-head center-elem">
                            ...
                            <span class="d-inline-block">Pending Applicants</span>
                            ...
                            <nav class="" aria-label="breadcrumb">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active breadcrumb-item" aria-current="page">
                                        ...
                                        Filter Pending Applicants List
                ...
                if (action == "delete") {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            Swal.fire("Approve", "Application approved successfully", "success");
                        }
                    });
                }
        ...
        var table =
            $('#process_data_table').DataTable({
                ...
                ajax: {
                    ...
                    url: '{{ route('pending-applicants-data') }}',
