                ...
                <div class="page-title-heading">
                    <div>
                        <div class="page-title-head center-elem">
                            ...
                            <span class="d-inline-block">Add New Cleaner</span>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <form method="post" action="{{ route('cleaner.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="card-body ">
                            ...
                            <div class="section">
                                <h5 class="card-title" style="margin-top: 7px;" >Fill Up With Cleaner
                                    Details : </h5>
                                <div class="form-row">
                                    ...
                                    <div class="form-group form-line-height col-lg-3 col-md-12">
                                        ...
                                        <input class="form-control" type="text" name="mother" placeholder="Mother name"
                                            required>
                                ...
                                <div class="form-row" >
                                    ...
                                    <div class="form-group form-line-height col-lg-3 col-md-12">
                                        ...
                                        <input class="form-control" type="textarea" name="permanent_address"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group form-line-height col-lg-3 col-md-12">
                                        <label class="input-label">National ID / Passport<span
                                                class="important">*</span></label>
                                        <input class="form-control" type="textarea" name="doc_no"
